...
public class DispositivosVinculados extends AppCompatActivity {
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            //finishAffinity(); //remove a number of Activitys belonging to a specific application from the current task

            // Realiza un intent para iniciar la siguiente actividad
            // mientras toma un EXTRA_DEVICE_ADDRESS que es la dirección MAC.
            Intent intend = new Intent(DispositivosVinculados.this,bluetoothActivity.class);
